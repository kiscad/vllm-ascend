...
#define SGMV_SHRINK_TYPE_DECLARE(TYPE)                                                             \
    extern "C" __global__ __aicore__ void sgmv_shrink_##TYPE(__gm__ void* x,                       \
                                                             __gm__ void* weight,                  \
                                                             __gm__ void* loraIndices,             \
                                                             uint32_t     loraIndicesSize,         \
                                                             __gm__ void* seqLen,                  \
...
namespace vllm_ascend
{
                                 ...
                                 float      scale)
    {
        ...
        {
            sgmv_shrink_half<<<blockDim, nullptr, stream>>>(x,
                                                            weight,
                                                            loraIndices,
                                                            loraIndicesSize,
                                                            seqLen,
        ...
        {
#if (__CCE_AICORE__ >= 220)
            sgmv_shrink_bfloat16_t<<<blockDim, nullptr, stream>>>(x,
                                                                  weight,
                                                                  loraIndices,
                                                                  loraIndicesSize,
                                                                  seqLen,
