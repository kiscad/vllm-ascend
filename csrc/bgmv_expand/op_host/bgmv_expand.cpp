#include "../op_kernel/bgmv_expand_kernel.h"
                       ...
                       int64_t slice_offset, int64_t slice_size)
{
    ...
    TORCH_CHECK(scalar_type == c10::kHalf || scalar_type == c10::kBFloat16, "only support half and bf16");
