...
#define BGMV_EXPAND_TYPE_DECLARE(TYPE)                                                             \
    extern "C" __global__ __aicore__ void bgmv_expand_##TYPE(__gm__ void* x,                       \
                                                             __gm__ void* weight,                  \
                                                             __gm__ void* indices,                 \
                                                             uint32_t     indicesSize,             \
                                                             __gm__ void* yIn,                     \
...
namespace vllm_ascend
{
                                 ...
                                 uint32_t   outputFullDim)
    {
        ...
        {
            bgmv_expand_half<<<blockDim, nullptr, stream>>>(x,
                                                            weight,
                                                            indices,
                                                            indicesSize,
                                                            yIn,
        ...
        {
#if (__CCE_AICORE__ >= 220)
            bgmv_expand_bfloat16_t<<<blockDim, nullptr, stream>>>(x,
                                                                  weight,
                                                                  indices,
                                                                  indicesSize,
                                                                  yIn,
